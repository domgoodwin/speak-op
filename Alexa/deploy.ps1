...
7za a -tzip  package-$version.zip package.json node_modules Elastic.js  main.js
aws s3 cp $file s3://speakop-lambda-deploy-new/$file
...
aws s3 rm s3://speakop-lambda-deploy-new/$file